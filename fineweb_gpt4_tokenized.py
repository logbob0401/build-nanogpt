...
# ------------------------------------------
local_dir = "edu_fineweb10B_gpt4_enc"
...
fw = load_dataset("HuggingFaceFW/fineweb-edu", name=remote_name, split="train",cache_dir="/mnt/bn/bozhang41/data/huggingface/datasets")
print(fw.builder_name)
tokenizer_name="cl100k_base"
# init the tokenizer
enc = tiktoken.get_encoding(tokenizer_name)
eot = enc._special_tokens['<|endoftext|>'] # end of text token
print(f"{tokenizer_name=} {enc.n_vocab=}")
